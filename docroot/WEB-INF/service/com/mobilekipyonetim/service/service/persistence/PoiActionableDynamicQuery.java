 ...
 * @generated
 */
public abstract class PoiActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PoiActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PoiLocalServiceUtil.getService());
		setClass(Poi.class);

		setClassLoader(com.mobilekipyonetim.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("poiEntityId");
	}
}