 ...
 * @generated
 */
public abstract class OrderPriorityActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public OrderPriorityActionableDynamicQuery() throws SystemException {
		setBaseLocalService(OrderPriorityLocalServiceUtil.getService());
		setClass(OrderPriority.class);

		setClassLoader(com.mobilekipyonetim.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("orderPriorityEntityId");
	}
}