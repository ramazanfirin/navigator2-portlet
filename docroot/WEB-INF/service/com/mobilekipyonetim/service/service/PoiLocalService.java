...
/**
 * Provides the local service interface for Poi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author 002834
 * @see PoiLocalServiceUtil
...
public interface PoiLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PoiLocalServiceUtil} to access the poi local service. Add custom service methods to {@link com.mobilekipyonetim.service.service.impl.PoiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
