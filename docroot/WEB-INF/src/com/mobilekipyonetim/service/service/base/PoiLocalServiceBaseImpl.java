...
import com.mobilekipyonetim.service.service.PoiLocalService;
...
/**
 * Provides the base implementation for the poi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mobilekipyonetim.service.service.impl.PoiLocalServiceImpl}.
 * </p>
 *
 * @author 002834
 ...
 * @generated
 */
public abstract class PoiLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements PoiLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.mobilekipyonetim.service.service.PoiLocalServiceUtil} to access the poi local service.
	 */
	...
	@Override
	public Poi addPoi(Poi poi) throws SystemException {
		poi.setNew(true);

		return poiPersistence.update(poi);
	}
	 ...
	 */
	@Override
	public Poi createPoi(int poiEntityId) {
		return poiPersistence.create(poiEntityId);
	}
	...
	@Override
	public Poi deletePoi(int poiEntityId)
		throws PortalException, SystemException {
		return poiPersistence.remove(poiEntityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Poi deletePoi(Poi poi) throws SystemException {
		return poiPersistence.remove(poi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Poi.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return poiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return poiPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return poiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return poiPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Poi fetchPoi(int poiEntityId) throws SystemException {
		return poiPersistence.fetchByPrimaryKey(poiEntityId);
	}
	 ...
	 */
	@Override
	public Poi getPoi(int poiEntityId) throws PortalException, SystemException {
		return poiPersistence.findByPrimaryKey(poiEntityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return poiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Poi> getPois(int start, int end) throws SystemException {
		return poiPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPoisCount() throws SystemException {
		return poiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Poi updatePoi(Poi poi) throws SystemException {
		return poiPersistence.update(poi);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.mobilekipyonetim.service.model.Poi",
			poiLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = poiPersistence.getDataSource();
	...
	private PoiLocalServiceClpInvoker _clpInvoker = new PoiLocalServiceClpInvoker();
}