...
import com.mobilekipyonetim.service.service.OrderPriorityLocalService;
...
/**
 * Provides the base implementation for the order priority local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mobilekipyonetim.service.service.impl.OrderPriorityLocalServiceImpl}.
 * </p>
 *
 * @author 002834
 * @see com.mobilekipyonetim.service.service.impl.OrderPriorityLocalServiceImpl
 * @see com.mobilekipyonetim.service.service.OrderPriorityLocalServiceUtil
 * @generated
 */
public abstract class OrderPriorityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OrderPriorityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.mobilekipyonetim.service.service.OrderPriorityLocalServiceUtil} to access the order priority local service.
	 */
	...
	@Override
	public OrderPriority addOrderPriority(OrderPriority orderPriority)
		throws SystemException {
		orderPriority.setNew(true);

		return orderPriorityPersistence.update(orderPriority);
	}
	 ...
	 */
	@Override
	public OrderPriority createOrderPriority(int orderPriorityEntityId) {
		return orderPriorityPersistence.create(orderPriorityEntityId);
	}
	...
	@Override
	public OrderPriority deleteOrderPriority(int orderPriorityEntityId)
		throws PortalException, SystemException {
		return orderPriorityPersistence.remove(orderPriorityEntityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OrderPriority deleteOrderPriority(OrderPriority orderPriority)
		throws SystemException {
		return orderPriorityPersistence.remove(orderPriority);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OrderPriority.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return orderPriorityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return orderPriorityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public OrderPriority fetchOrderPriority(int orderPriorityEntityId)
		throws SystemException {
		return orderPriorityPersistence.fetchByPrimaryKey(orderPriorityEntityId);
	}
	 ...
	 */
	@Override
	public OrderPriority getOrderPriority(int orderPriorityEntityId)
		throws PortalException, SystemException {
		return orderPriorityPersistence.findByPrimaryKey(orderPriorityEntityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return orderPriorityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OrderPriority> getOrderPriorities(int start, int end)
		throws SystemException {
		return orderPriorityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getOrderPrioritiesCount() throws SystemException {
		return orderPriorityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OrderPriority updateOrderPriority(OrderPriority orderPriority)
		throws SystemException {
		return orderPriorityPersistence.update(orderPriority);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.mobilekipyonetim.service.model.OrderPriority",
			orderPriorityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = orderPriorityPersistence.getDataSource();
	...
	private OrderPriorityLocalServiceClpInvoker _clpInvoker = new OrderPriorityLocalServiceClpInvoker();
}