...
import com.mobilekipyonetim.service.service.VehicleLocalService;
...
/**
 * Provides the base implementation for the vehicle local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mobilekipyonetim.service.service.impl.VehicleLocalServiceImpl}.
 * </p>
 *
 * @author 002834
 ...
 * @generated
 */
public abstract class VehicleLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VehicleLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.mobilekipyonetim.service.service.VehicleLocalServiceUtil} to access the vehicle local service.
	 */
	...
	@Override
	public Vehicle addVehicle(Vehicle vehicle) throws SystemException {
		vehicle.setNew(true);
	 ...
	 */
	@Override
	public Vehicle createVehicle(int vehicleEntityId) {
		return vehiclePersistence.create(vehicleEntityId);
	}
	...
	@Override
	public Vehicle deleteVehicle(int vehicleEntityId)
		throws PortalException, SystemException {
		return vehiclePersistence.remove(vehicleEntityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Vehicle deleteVehicle(Vehicle vehicle) throws SystemException {
		return vehiclePersistence.remove(vehicle);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Vehicle.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vehiclePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vehiclePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return vehiclePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehiclePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return vehiclePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Vehicle fetchVehicle(int vehicleEntityId) throws SystemException {
		return vehiclePersistence.fetchByPrimaryKey(vehicleEntityId);
	}
	 ...
	 */
	@Override
	public Vehicle getVehicle(int vehicleEntityId)
		throws PortalException, SystemException {
		return vehiclePersistence.findByPrimaryKey(vehicleEntityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vehiclePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Vehicle> getVehicles(int start, int end)
		throws SystemException {
		return vehiclePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVehiclesCount() throws SystemException {
		return vehiclePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Vehicle updateVehicle(Vehicle vehicle) throws SystemException {
		return vehiclePersistence.update(vehicle);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.mobilekipyonetim.service.model.Vehicle",
			vehicleLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vehiclePersistence.getDataSource();
	...
	private VehicleLocalServiceClpInvoker _clpInvoker = new VehicleLocalServiceClpInvoker();
}