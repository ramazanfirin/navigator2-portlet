...
import com.mobilekipyonetim.service.service.BranchLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mobilekipyonetim.service.service.impl.BranchLocalServiceImpl}.
 * </p>
 *
 * @author 002834
...
public abstract class BranchLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BranchLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.mobilekipyonetim.service.service.BranchLocalServiceUtil} to access the branch local service.
	 */
	...
	@Override
	public Branch addBranch(Branch branch) throws SystemException {
		branch.setNew(true);
	 ...
	 */
	@Override
	public Branch createBranch(int entityId) {
		return branchPersistence.create(entityId);
	}
	...
	@Override
	public Branch deleteBranch(int entityId)
		throws PortalException, SystemException {
		return branchPersistence.remove(entityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Branch deleteBranch(Branch branch) throws SystemException {
	...
	@Override
	public Branch fetchBranch(int entityId) throws SystemException {
		return branchPersistence.fetchByPrimaryKey(entityId);
	}
	 ...
	 */
	@Override
	public Branch getBranch(int entityId)
		throws PortalException, SystemException {
		return branchPersistence.findByPrimaryKey(entityId);
	}
	 ...
	 */
	@Override
	public int getBranchsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Branch updateBranch(Branch branch) throws SystemException {
		return branchPersistence.update(branch);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.mobilekipyonetim.service.model.Branch",
			branchLocalService);
	}
	...
	private BranchLocalServiceClpInvoker _clpInvoker = new BranchLocalServiceClpInvoker();
}